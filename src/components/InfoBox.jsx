...
const PUNCH_TYPE_LIST = ['(empty)', 'Straight', 'Hook', 'Uppercut'];
...
const InfoBox = ( {
  ...
  useKeyboardShortcut(
    ...
    return (
        punchDisabled ? infoBoxDisabled : infoBoxEnabled
    );
